...
class DayView<T extends Object?> extends StatefulWidget {
  ...
  ///dispose
  final Function(EventController<T>? eventController, PageController pageController)? dispose;
...
class DayViewState<T extends Object?> extends State<DayView<T>> {
  ...
  @override
  void dispose() {
    widget.dispose?.call(_controller, _pageController);
    // _controller?.removeListener(_reloadCallback);
                      ...
                      itemBuilder: (_, index) {
                        ...
                        return ValueListenableBuilder(
                          ...
                          builder: (_, __, ___) => InternalDayViewPage<T>(
                            ...
                            hourLinePainter: widget.hourLinePainter,
                            date: date,
